...
const Services = () => {
  return (
    <div className="container mx-auto px-6 mt-16">
      {/* Header Section */}
      <div className="text-left lg:text-center max-w-lg mx-auto">
        <h1 className="font-bold text-2xl">Our Services</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
        {serviceData.first.map((item, index) => (
          <div
            key={index}
            className="bg-white rounded-lg text-left hover:shadow-lg p-6"
          >
            <img src={item.image} width="50px" className="mt-4" />
